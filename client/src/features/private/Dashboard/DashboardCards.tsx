...
const Card = ({ img, alt, text, linkText, linkTo }: CardProps) => {
    return (
        <div className="flex flex-row items-center justify-around gap-4 p-8 bg-white rounded-lg">
            <img src={img} alt={alt} className="w-1/3 h-1/3" />
...
const DashboardCards = () => {
    return (
        <div className="flex flex-row items-center justify-around gap-4 mb-8">
